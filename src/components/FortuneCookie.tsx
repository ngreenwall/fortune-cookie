...
export function FortuneCookie({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      disabled={disabled || phase !== "intact"}
      ...
      className={[
        ...
        disabled || phase !== "intact" ? "cursor-default" : "cursor-pointer hover:scale-[1.03] active:scale-[0.97]",
        isMatched ? "animate-match-glow" : "",
      ]
        .filter(Boolean)
        .join(" ")}
    >
      ...
      >
        ...
        <path
          ...
          fill="var(--color-cookie)"
          stroke="var(--color-cookie-dark)"
          strokeWidth="1.5"
